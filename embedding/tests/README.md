...
### Run All Tests
```bash
# Discover and run all tests in tests/core/
...
```bash
python -m unittest tests/core/test_embedding_service.py -v
```

**Test Chunking Service:**
```bash
python -m unittest tests/core/test_chunking_service.py -v
```

**Test Database Service:**
```bash
python -m unittest tests/core/test_database_service.py -v
```

### Run Specific Test Class
```bash
python -m unittest tests.core.test_embedding_service.TestEmbeddingService -v
```

### Run Specific Test Method
```bash
python -m unittest tests.core.test_embedding_service.TestEmbeddingService.test_encode_single_text -v
```
...
1. Create corresponding test file in tests/core/
